...
PaperMind uses [uv](https://github.com/astral-sh/uv) for dependency management.
...
PaperMind includes an automated RAG evaluation pipeline (`evaluate.py`) built on [DeepEval](https://github.com/confident-ai/deepeval).
